...
def train_net(net,
    ...
    dataset = BasicDataset(dir_img, data_type='train', transform=transform)
    ...
    # (Initialize logging)
    experiment = wandb.init(project='airbus-ship-detection', resume='allow', anonymous='must')
...
if __name__ == '__main__':
    ...
    # 여기서 여러 모델들을 정의해주자. 일단은 pretrained 모델들을 이용하여 학습을 진행하고 결과를 살펴보자.
    # 한 5개 정도의 모델들을 살펴보자.
